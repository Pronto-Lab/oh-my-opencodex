...
import type { OhMyOpenCodexConfig } from "../../config"
...
const isAgentDisabled = (agentConfigKey: string, config: OhMyOpenCodexConfig): boolean => {
...
const pickFallbackAgent = (config: OhMyOpenCodexConfig): CoreAgentKey => {
...
export const resolveRunAgent = (
  options: RunOptions,
  pluginConfig: OhMyOpenCodexConfig,
