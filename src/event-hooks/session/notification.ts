...
function buildNotificationCommand(config: OhMyCodexConfig): string | null {
  ...
  if (process.platform === "darwin") {
    return `osascript -e 'display notification "Turn completed" with title "oh-my-codex"'`
  }

  if (process.platform === "linux") {
    return "notify-send 'oh-my-codex' 'Turn completed'"
  }
