...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (oh-my-opencodex.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "oh-my-opencodex.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/oh-my-opencodex.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "oh-my-opencodex.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "oh-my-opencodex.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "oh-my-opencodex.jsonc"), jsoncContent, "utf-8")
