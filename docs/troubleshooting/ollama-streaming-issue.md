...
When using Ollama as a provider with oh-my-opencodex agents, you may encounter:
...
- **oh-my-opencodex**: Passes through the SDK's behavior (can't fix at this layer)
...
- **oh-my-opencodex**: https://github.com/code-yeongyu/oh-my-opencodex/issues/1124
