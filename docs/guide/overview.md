# Oh My OpenCodex Overview

Learn about Oh My OpenCodex, a plugin that transforms OpenCode into the best agent harness.
...
## What Oh My OpenCodex Does for You
...
Oh My OpenCodex automatically configures models based on your available providers. You don't need to manually specify every model.

### How Models Are Determined

**1. At Installation Time (Interactive Installer)**

When you run `bunx oh-my-opencodex install`, the installer asks which providers you have:
...
Based on your answers, it generates `~/.config/opencode/oh-my-opencodex.json` with optimal model assignments for each agent and category.
...
- [Ultrawork Manifesto](../ultrawork-manifesto.md) - Philosophy and principles behind Oh My OpenCodex
