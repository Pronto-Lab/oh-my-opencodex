...
> **보안 경고: 사칭 사이트**
>
> **ohmyopencodex.com은 이 프로젝트와 제휴 관계가 아닙니다.** 우리는 해당 사이트를 운영하거나 지지하지 않습니다.
>
> OhMyOpenCodex는 **무료 오픈 소스**입니다. "공식"을 표방하는 제3자 사이트에서 설치 프로그램을 다운로드하거나 결제 정보를 입력하지 마십시오.
>
> 사칭 사이트는 유료 벽 뒤에 있어 **배포하는 내용을 확인할 수 없습니다.** 해당 사이트의 다운로드는 **잠재적으로 위험한 것으로 간주**하세요.
>
> ✅ 공식 다운로드: https://github.com/code-yeongyu/oh-my-opencodex/releases
...
> [!TIP]
>
> [![Oh My OpenCodex 3.0이 정식 출시되었습니다!](./.github/assets/orchestrator-atlas.png?v=3)](https://github.com/code-yeongyu/oh-my-opencodex/releases/tag/v3.0.0)
> > **Oh My OpenCodex 3.0이 정식 출시되었습니다! `oh-my-opencodex@latest`를 사용하여 설치하세요.**
>
> 함께해요!
>
> | [<img alt="Discord link" src="https://img.shields.io/discord/1452487457085063218?color=5865F2&label=discord&labelColor=black&logo=discord&logoColor=white&style=flat-square" width="156px" />](https://discord.gg/PUwSMR9XNk) | 기여자와 동료 `oh-my-opencodex` 사용자와 연결하려면 [Discord 커뮤니티](https://discord.gg/PUwSMR9XNk)에 가입하세요. |
> | :-----| :----- |
> | [<img alt="X link" src="https://img.shields.io/badge/Follow-%40justsisyphus-00CED1?style=flat-square&logo=x&labelColor=black" width="156px" />](https://x.com/justsisyphus) | `oh-my-opencodex`에 대한 뉴스와 업데이트가 제 X 계정에 게시되었습니다. <br /> 실수로 정지된 이후, [@justsisyphus](https://x.com/justsisyphus)가 제 대신 업데이트를 게시합니다. |
...
> 이것은 코딩을 스테로이드로 만드는 것 — 실제로 작동하는 `oh-my-opencodex`입니다. 백그라운드 에이전트 실행, 오라클, 라이브러리언, 프론트엔드 엔지니어와 같은 전문 에이전트 호출. 정교하게 제작된 LSP/AST 도구, 큐레이팅된 MCP, 완전한 Claude Code 호환 계층 사용.

# Claude OAuth 액세스 공지

## TL;DR

> Q. oh-my-opencodex를 사용할 수 있나요?
...
>
> [**Anthropic은 이 프로젝트 oh-my-opencodex를 opencode 차단의 정당화로 인용했습니다.**](https://x.com/thdxr/status/2010149530486911014)
>
...
> "oh-my-opencodex를 사용하세요, 다시는 돌아갈 수 없을 것입니다" — [d0t3ch](https://x.com/d0t3ch/status/2001685618200580503)
...
> "Oh My OpenCodex는 실제로 미칩니다" - [YouTube - Darren Builds AI](https://www.youtube.com/watch?v=G_Snfh2M41M)
...
3. LLM에 위임할 때 컨텍스트 관리에 대해 걱정하지 마세요. 내가 다 처리했습니다.
    - OhMyOpenCodex는 컨텍스트 부하를 줄이기 위해 공격적으로 여러 에이전트를 활용합니다.
...
oh-my-opencodex를 제거하려면:

1. **OpenCode 구성에서 플러그인 제거**

   `~/.config/opencode/opencode.json`(또는 `opencode.jsonc`)을 편집하고 `plugin` 배열에서 `"oh-my-opencodex"`를 제거하세요:
...
**빠른 개요:**
- **구성 위치**: `.opencode/oh-my-opencodex.json`(프로젝트) 또는 `~/.config/opencode/oh-my-opencodex.json`(사용자)
...
- [1.0.132](https://github.com/sst/opencode/releases/tag/v1.0.132) 이전 버전을 사용 중인 경우 OpenCode 버그로 인해 구성이 손상될 수 있습니다.
  - [수정 사항](https://github.com/sst/opencode/pull/5040)은 1.0.132 이후에 병합되었습니다 — 더 새로운 버전을 사용하세요.
    - 재미있는 사실: 해당 PR은 OhMyOpenCodex의 Librarian, Explore 및 Oracle 설정 덕분에 발견되고 수정되었습니다.
